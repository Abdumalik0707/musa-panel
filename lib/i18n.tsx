...
const dict = {
  uz: {
    ...
    detail_delete_order: "🗑️ Buyurtmani o'chirish",
    confirm_delete_order: "Bu buyurtmani o'chirishga ishonchingiz komilmi?",

    // Customers: search/filter/edit/delete
    search_placeholder: "Ism yoki telefon bo'yicha qidirish...",
    filter_from_date: "Sanadan",
    filter_to_date: "Sanagacha",
    filter_clear: "Tozalash",
    th_actions: "Amallar",
    action_edit: "Tahrirlash",
    action_delete: "O'chirish",
    confirm_delete_customer: "Bu mijozni o'chirishga ishonchingiz komilmi?",
    edit_customer_title: "Mijozni tahrirlash",
    edit_save: "Saqlash",
  ...
  en: {
    ...
    detail_delete_order: "🗑️ Delete order",
